 ...
 */
public class ComplexCollectionTypesNoContentTest extends AbstractJcxUnmarshaller {
  ...
  @EqualsAndHashCode
  @FieldDefaults(level = AccessLevel.PRIVATE)
  public static final class WithXmlAdapter implements IContent {
