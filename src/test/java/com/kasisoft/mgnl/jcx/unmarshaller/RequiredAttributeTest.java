 ...
 */
public class RequiredAttributeTest extends AbstractJcxUnmarshaller {
  ...
  public void simplePrimitiveTypes() throws Exception {
    ...
    TreeBuilder tb = new TreeBuilder()
      .sContentNode( "requiredAttribute" )
    ...
    unmarshaller.createCreator( SimplePrimitiveTypes.class ).apply( biboSession.getNode( "/requiredAttribute" ) );
    fail();
